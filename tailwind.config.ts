...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        "grid-fade":
          "radial-gradient(circle at 50% 0%, rgba(77,163,255,0.12), transparent 60%)",
        "noise":
      ...
      keyframes: {
        ...
        pulseGlow: {
          "0%,100%": { boxShadow: "0 0 0 0 rgba(77,163,255,0.35)" },
          "50%": { boxShadow: "0 0 0 12px rgba(77,163,255,0)" },
        },
        floaty: {
